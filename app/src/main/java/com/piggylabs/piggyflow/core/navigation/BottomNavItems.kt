...
/** Personal tabs: Home, Expenses, Tracker, Reports. The Add action sits between
 * Expenses and Tracker as its own element in [com.piggylabs.piggyflow.core.navigation.BottomBar],
