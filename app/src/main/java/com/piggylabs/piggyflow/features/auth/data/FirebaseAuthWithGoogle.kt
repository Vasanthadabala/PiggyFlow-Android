package com.piggylabs.piggyflow.features.auth.data
...
fun firebaseAuthWithGoogle(
    ...
    FirebaseAuth.getInstance()
        ...
        .addOnSuccessListener { result ->
            ...
            val accountType = prefs.snapshotBlocking().accountType.lowercase()
                    ...
                    if (!doc.exists()) {
                        ...
                        ref.set(data)
                            .addOnSuccessListener {
                                ...
                                prefs.setSignedInAsync(user.uid, user.displayName ?: "User")
                        ...
                        ref.set(updates, SetOptions.merge())
                            .addOnSuccessListener {
                                prefs.setSignedInAsync(user.uid, resolvedName)
